...
import net.tomsaw31.thefoodrealm.screen.slot.ModResultSlot;
...
public class CookingPotMenu extends AbstractContainerMenu {
    ...
    public CookingPotMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.COOKING_POT_MENU.get(),id);
        checkContainerSize(inv,7);
        blockEntity = (CookingPotBlockEntity) entity;
     ...
     this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
         ...
         this.addSlot(new SlotItemHandler(handler, 1, 62, 23));
         this.addSlot(new SlotItemHandler(handler, 2, 80, 23));
         this.addSlot(new SlotItemHandler(handler, 3, 44, 41));
         this.addSlot(new SlotItemHandler(handler, 4, 62, 41));
         this.addSlot(new SlotItemHandler(handler, 5, 80, 41));
         this.addSlot(new ModResultSlot(handler, 6, 140, 33));
    });
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.COOKING_POT.get());
    }
